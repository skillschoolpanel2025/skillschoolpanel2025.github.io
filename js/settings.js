...
class SettingsManager {
        ...
        if (settingsLink) {
            ...
            settingsLink.addEventListener('click', (e) => {
                ...
                if (settingsSection) {
                    ...
                    // Заголовок страницы уже установлен в HTML
                } else {
                    console.error('Раздел настроек не найден');
                }
            });
        ...
        switch (theme) {
            case 'dark':
                themeCSS = `
                    ...
                    .settings-block, .stats-card, .stats-chart-container, .card, .sidebar, .modal-content, .user-card {
                        background-color: rgba(30, 30, 40, 0.6);
                    }
                    .nav-link, .content-title, .stats-card-label, .settings-block h3, .sidebar-title, .nav-title {
                        color: #ffffff;
                    }
                    .nav-link:hover {
            ...
            case 'light':
                themeCSS = `
                    ...
                    .settings-block, .stats-card, .stats-chart-container, .card, .modal-content, .user-card {
                        background-color: #ffffff;
                        color: #333333;
                        box-shadow: 0 2px 6px rgba(0, 0, 0, 0.1);
                    }
                    .settings-block h3, .stats-card-label, .sidebar-title, .nav-title {
                        color: #555;
                    }
                    .content-title {
                        color: #333;
    ...
    applyFont(font, size) {
        ...
        // Создаем или обновляем стиль для шрифтов
        ...
        // Задаем CSS для всех элементов интерфейса с приоритетом !important
        fontStyle.textContent = `
            /* Глобальное применение шрифта, с исключением для Font Awesome */
            *:not(.fa):not(.fas):not(.far):not(.fal):not(.fab) {
            ...
            .nav-link, button, input, select, textarea, .stats-card-label, 
            .settings-block h3, .content-title, .modal-title, .user-name, 
            .sidebar-title, table, .table th, .table td, label, p, span, div,
            .auth-header h2, .preloader-title, .preloader-subtitle, .loading-status,
            .fun-fact, .progress-message, #resourceCount, .resource-item,
            .settings-row, #fontPreviewText, .modal *, .tooltip, #loadingContent,
            ...
            .content-title {
                font-size: ${parseInt(size) + 8}px !important;
            }
            
            .nav-link {
                font-size: ${parseInt(size)}px !important;
            }
            
            button, input, select, textarea {
                font-size: ${parseInt(size) - 1}px !important;
            }
            
            /* Инструкции и другие модальные окна */
            #instructionModal {
                font-family: ${fontFamily} !important;
            }
            
            /* Прелоадер и его элементы */
            #sitePreloader *, .site-preloader * {
                font-family: ${fontFamily} !important;
            }
            
            /* Принудительное переопределение для всех элементов с font-family, кроме Font Awesome */
            [style*="font-family"]:not(.fa):not(.fas):not(.far):not(.fal):not(.fab) {
                font-family: ${fontFamily} !important;
            }
            
            /* Явное исключение для Font Awesome */
            .fa, .fas, .far, .fal, .fab, i[class*="fa-"] {
                font-family: "Font Awesome 6 Free" !important;
            }
        `;
        
        // Также применяем CSS переменные
        ...
        console.log('Шрифт применен ко всем элементам:', font, size, fontFamily);
    }
}

// ВАЖНО: Используйте supabaseClient вместо supabase для всех запросов к Supabase!

// Скрыть ошибку по умолчанию при загрузке
...
class Auth {
    ...
    async init() {
        ...
        // Скрыть ошибку при инициализации
        this.hideError();
    }
...
document.getElementById('authForm').addEventListener('submit', async (e) => {
    ...
    try {
        ...
        // Ошибка уже обработана в методе signIn
    }
});
